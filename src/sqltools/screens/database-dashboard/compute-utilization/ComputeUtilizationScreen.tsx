...
import { Box, Paper, Tooltip, IconButton, FormControl, FormGroup, FormControlLabel, Switch, InputLabel, Select, MenuItem, Typography, SelectChangeEvent } from "@mui/material"
                ...
                <div style={{ float: 'right' }}>
                    ...
                    {metadata && metadata.supportsHistorical &&
                        <Tooltip title="Configure Data Recording">
                            <IconButton onClick={() => setJobConfigureDialogOpen(true)} size="large">
                                <SettingsIcon />
                            </IconButton>
                        </Tooltip>}
                    {!historicalScreenFlag &&
                        <Tooltip title="Reload">
                            <IconButton onClick={() => setIsReload(!isReload)} size="large">
                                <ReplayIcon />
                            </IconButton>
                        </Tooltip>}
                </div>
